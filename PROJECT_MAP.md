...
│       ├── ui.test.tsx       # Tests d'intégration HTTP sur le rendu des pages (login/register/dashboard/users) ; (Sprint 18) + gating alerts.view (dashboard/header), + /dashboard/reports pour MEMBER, + garde reservations.import (page + 404 notFound()), + avertissement groupe ADMIN, + formulaire tenant masqué pour non-ADMIN
